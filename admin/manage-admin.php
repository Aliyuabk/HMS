        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h2 class="mainTitle">Admin | admins</h2>
                        </div>
                        <ol class="breadcrumb">
                            <li>Admin</li>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-tools">
                                        <a href="add-users.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add admin</a>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                <td><img src="<?= htmlspecialchars($row['photo']); ?>" style="width:50px;height:50px;border-radius:50%;margin-right:10px;" alt=""></td>
                                                ...
                                                <td>
                                                    <a href="edit-user.php?id=<?= $row['id']; ?>&role=admin" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                    <a href="manage-admin.php?delete=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this user?');"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
