...
// Fetch monthly payments from all three tables, merged by patient
$paymentsQuery = "
...
<section id="page-title">
    <div class="row">
        <div class="col-sm-8">
            <h2 class="mainTitle">Cashier | Monthly Bills (<?= date("F Y") ?>)</h2>
        </div>
    </div>
</section>
...
<div class="container-fluid container-fullw bg-white">
    <table class="table table-bordered table-hover">
        ...
        <?php
            ...
            echo '<tr><td colspan="6" class="text-center">No bills found for this month</td></tr>';
        }
        ?>
        </tbody>
    </table>
