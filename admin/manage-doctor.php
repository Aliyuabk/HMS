        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h2 class="mainTitle">Admin | doctors</h2>
                        </div>
                        <ol class="breadcrumb">
                            <li>Admin</li>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-tools">
                                        <a href="add-users.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add doctor</a>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                 <td><img src="../doctor/<?= htmlspecialchars($row['photo']);  ?>" style="width:50px;height:50px;object-fit:cover;border-radius:100%" alt=""></td>
                                                ...
                                                <td>
                                                    <a href="edit-user.php?id=<?= $row['id']; ?>&role=doctor" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                    <a href="manage-doctor.php?delete=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this user?');"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
