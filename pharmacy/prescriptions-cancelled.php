...
<html lang="en">
<head>
    <title>Cancelled Prescriptions</title>
...
<section id="page-title">
    <div class="row">
        <div class="col-sm-8">
            <h2 class="mainTitle">Cancelled Prescriptions</h2>
        </div>
        <ol class="breadcrumb">
            <li><span>Pharmacy</span></li>
            <li class="active"><span>Cancelled Prescriptions</span></li>
        </ol>
    </div>
</section>
...
<?php
    ...
    echo '<tr><td colspan="8" class="text-center">No cancelled prescriptions found</td></tr>';
}
?>
</tbody>
</table>
