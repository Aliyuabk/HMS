...
if(mysqli_num_rows($check_appointments) > 0) {
    ...
    $appointments_query = mysqli_query($con, "SELECT COUNT(*) as total FROM appointments WHERE radiology_id = '$user_id' AND appointment_date = '$today' AND status = 'scheduled'");
    ...
    $patients_query = mysqli_query($con, "SELECT COUNT(DISTINCT patient_id) as total FROM appointments WHERE radiology_id = '$user_id'");
    if($patients_query) {
...
if(mysqli_num_rows($check_prescriptions) > 0) {
    ...
    $prescriptions_query = mysqli_query($con, "SELECT COUNT(*) as total FROM prescriptions WHERE radiology_id = '$user_id' AND status = 'pending'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h2 class="mainTitle">radiology | Dashboard</h2>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>radiology</span>
												...
												<table class="table table-bordered table-hover">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<span class="radiologyel radiologyel-<?php 
														...
														<tr>
															<td colspan="5" class="text-center">
																<div class="alert alert-info">
																	...
																	<?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'radiology') { ?>
